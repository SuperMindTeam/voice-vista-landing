...
const Hero = () => {
  ...
  <div className={isMobileLayout 
    ...
    : "relative mt-8 w-full flex justify-center md:absolute md:bottom-2 md:left-1/2 md:transform md:-translate-x-1/2 lg:relative lg:mt-8 lg:right-2 lg:transform-none lg:-translate-y-[24rem]"
  }>
    <VapiMicButton 
