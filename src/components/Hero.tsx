...
const Hero = () => {
  ...
  <div className={isMobileLayout ? "relative mt-12 w-full flex justify-center" : "relative mt-8 w-full flex justify-center"}>
    {/* Container for both SVGs */}
    <div className={isMobileLayout 
      ? "flex flex-col items-center space-y-4" 
      : "absolute right-6 -translate-y-[28rem] flex flex-col items-end space-y-[-1rem]"
    }>
      <img 
