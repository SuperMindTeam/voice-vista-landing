      ...
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <span className="font-display font-bold text-xl" style={{ color: '#6C69AB' }}>Shiv AI</span>
          </div>
          ...
          <div className="hidden md:flex items-center">
            <Button size="sm" className="text-sm font-medium bg-[#6C69AB] hover:bg-[#5a579a] text-white shadow-sm">
              Free Trial
            </Button>
          </div>
      ...
      >
        <nav className="flex flex-col px-8 py-4 space-y-6">
          ...
          <div className="pt-6 border-t">
            <Button 
              className="w-full bg-[#6C69AB] hover:bg-[#5a579a] text-white"
              onClick={() => setMobileMenuOpen(false)}
            >
              Free Trial
            </Button>
